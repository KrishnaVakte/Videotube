...
function EditVideo({
    ...
    if (uploading) {
        return (
            <>
                <div className="w-52 border border-slate-600 bg-richblack-900 flex gap-2 p-3">
                    <Spinner />
    ...
    return (
        <>
            <div className="fixed mt-5 top-0 left-0 w-full h-full flex justify-center items-center bg-richblack-900 bg-opacity-70 z-50">
                <form
                    onSubmit={handleSubmit(updateVideo)}
                    className=" bg-richblack-900 space-y-2 border h-[30rem] overflow-y-scroll outline-none p-2"
                >
                    ...
                    <div className="p-2 grid lg:grid-cols-2 grid-cols-1 gap-5 z-40">
                        ...
                        <div className="flex flex-col justify-between sm:gap-0 gap-2">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button
                                    className="flex-1 bg-purple p-2 font-bold"
