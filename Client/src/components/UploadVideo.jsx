...
function UploadVideo({ setUploadVideoPopup }) {
    ...
    return (
        <>
            <div className="fixed top-5 left-0 w-full h-full flex justify-center items-center bg-richblack-900 bg-opacity-70 z-30">
                <div className="relative w-[95vw] sm:w-3/4 h-[80vh] sm:h-[80vh] mx-auto text-white border overflow-y-scroll bg-richblack-900">
                    <form
                        onSubmit={handleSubmit(publishVideo)}
                        className="space-y-5"
                    >
                        <section className="h-12 sticky top-0 z-50 border-b w-full bg-richblack-700 flex justify-between items-center px-3">
                            ...
                            <div>
                                <Button
                                    className="bg-purple py-1 px-2 font-bold"
                        ...
                        <section className="px-6 py-2">
                            <div className="w-full border border-dotted h-44 p-1 flex flex-col gap-3 justify-center items-center text-center">
                                ...
                                <label
                                    ...
                                    className="cursor-pointer bg-purple text-black font-bold text-sm py-2 px-4"
                                >
                                    Select Files
                                </label>
                                <input
                            ...
                            <div className="space-y-5 mt-2 w-full grid lg:grid-cols-2 grid-cols-1 lg:gap-10 justify-start items-start">
                                ...
                                <div className="w-full">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            rows="5"
                                            className="focus:bg-richblack-800 bg-transparent outline-none border w-full mt-1 p-1"
